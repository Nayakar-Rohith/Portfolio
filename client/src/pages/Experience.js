...
function Experience() {
  return (
    <section className="max-w-7xl mx-auto px-5 my-6 text-white" id='experience'>
      
      <div className="text-center">
        <h3 className="text-textc text-3xl font-bold mb-16">Work Experience</h3>
      </div>
      <div
        className="my-16 flex flex-col md:flex-row justify-around gap-12"
      >
        <div
          className=" w-[354px] bground  bg-card px-5 py-8 rounded-lg border border-primary shadow-[#5dadec3b] cursor-pointer shadow-xl"
        >
          <img
            src={TCS}
            alt="TCS"
            className="w-[196px] rounded-full mb-12 mx-auto"
          />
          <div className='my-3'>
        ...
        >
          <img
            src={cedar}
            alt="cedar"
            className="w-[196px] mb-12 mx-auto rounded-full"
          />
          <div className='my-3'>
